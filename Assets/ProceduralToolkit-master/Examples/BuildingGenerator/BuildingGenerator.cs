...
namespace ProceduralToolkit.Examples
{
    ...
    public static class BuildingGenerator
    {
        ...
        public static MeshDraft BuildingDraft(float width, float length, int floorCount, bool hasAttic, Color wallColor, bool centered = false)
        {
            ...
            else
            {
                ...
                Vector3.right*length + Vector3.forward*width,
