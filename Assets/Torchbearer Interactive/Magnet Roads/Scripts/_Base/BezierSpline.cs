...
// 
// Written by: Jonathan H Langley - jon@tbinteractive.co.uk, 21st September 2016
// ************************************************************************
...
namespace BezierSplines
{
    ...
    public class BezierSplineEditorInspector : Editor
    {
        ...
        private void SnapFirstAndLastPoints()
        {
        ...
        private Vector3 ShowPoint(int index)
        {
            ...
            if (Handles.Button(point, _handleRotation, size * _handleSize, size * _pickSize, Handles.DotCap))
            {
